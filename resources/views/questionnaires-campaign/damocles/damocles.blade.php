        ...
        <div class="flex flex-col sm:flex-row item-center gap-3">
            ...
            <ul class="flex flex-row gap-1 flex-wrap break-words text-sky-800">
                ...
                @if (isset($questionnaireCampaignId) && isset($questionnaireId))
                    <li><a href="{{ route('questionnaires-campaign.index') }}">@lang('questionnaire-campaign.damocles.questionnaires')</a></li>
                    <li>/</li>
                    <li><a
                            href="{{ route('damocles.index', ['questionnaireCampaign' => $questionnaireCampaignId, 'questionnaire' => $questionnaireId]) }}">@lang('questionnaire-campaign.damocles.damocles')</a>
                    </li>
                @else
                    <li><a href="{{ route('questionnaires') }}">@lang('questionnaire-campaign.damocles.questionnaires')</a>
                    </li>
                    <li>/</li>
                    <li>@lang('questionnaire-campaign.damocles.damocles')</li>
                @endif
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-sky-900">
                    ...
                    <!-- Questionnaire -->
                    <form class="pb-4" action="{{ route('damocles.create') }}" method="POST">
                        @csrf
                        @method('post')
                        ...
                        <p class="text-2xl font-semibold text-center">@lang('questionnaire-campaign.damocles.damoclesQuestionnaire')</p>
                            ...
                            <div class="tab hidden">
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I provide my personal credentials to a third
                                        party
                                        via email without first verifying the authenticity of the sender.</p>
                                    <div
                                ...
                                <!-- Q2 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I find myself tempted by curiosity to click
                                        on links
                                        in emails.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                ...
                                <!-- Q3 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I think that I can be targeted as a victim
                                        of a
                                        phishing attack.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I use different ways of communication (e.g.
                                        phone
                                        call) to check the legitimacy of the request made in an email/message from a
                                        known sender.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                ...
                                <!-- Q5 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I am likely to collaborate with other
                                        people to
                                        assess the authenticity of the emails I receive.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                                ...
                                <!-- Q6 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I use apps or websites to discover who is
                                        the
                                        sender, if I receive a message from an unknown telephone number.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I depend on my own knowledge to assess the
                                        credibility of the content in the emails I receive.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I wait a few (e.g., 2, 3 minutes) minutes
                                        before
                                        interacting with emails that make me feel strong emotions or a sense of
                                        urgency.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                            ...
                            <div class="tab hidden">
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I verify the authenticity of websites by
                                        examining
                                        webpages for grammatical errors and identifying any suspicious links while
                                        browsing.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                ...
                                <!-- Q13 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I make sure that all programs installed on
                                        my
                                        computer are up to date.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                                ...
                                <!-- Q14 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I back up all the data I store on my PC.
                                    </p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">Password managers are a reliable tool for
                                        protecting my privacy and sensitive data.</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                                ...
                                <!-- Q16 -->
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I am inclined to improve my knowledge about
                                        a
                                        password
                                        manager</p>
                                    <div
                                ...
                                <div class="py-3 flex flex-col border-b-2">
                                    <p class="text-center font-medium py-3">I experiment password managers with trial
                                        periods
                                        to
                                        assess their suitability for my needs..</p>
                                    <div
                                        class="flex flex-col md:flex-row items-top md:items-center w-full md:justify-around">
                                        <div class="flex flex-row md:flex-col items-center">
                                            <input class="cursor-pointer checked:bg-sky-800 hover:bg-sky-600"
                        ...
                        <div class="flex w-full items-center py-4">
                            <div class="flex w-1/3 justify-center">
                                <x-primary-button type="button" id="prevBtn"
                                    onclick="nextPrev(-1)">@lang('questionnaire-campaign.damocles.previous')</x-primary-button>
                            </div>
                            ...
                            <div class="flex w-1/3 justify-center">
                                <x-primary-button type="button" id="nextBtn"
                                    onclick="nextPrev(1)">@lang('questionnaire-campaign.damocles.next')</x-primary-button>

                                @if (Auth::user() && Auth::user()->role == 'User')
                                    <x-primary-button id="submit" class="hidden"
                                        type="submit">@lang('questionnaire-campaign.damocles.submit')</x-primary-button>
                                @endif
                            </div>
                        </div>
...
<x-modal name="error-modal" id="error-modal" title="Compile all the questions!" :show="false">
    <div class="p-4 rounded-lg relative text-center">
        <p class="text-2xl font-semibold text-red-700 pb-8">@lang('questionnaire-campaign.damocles.compileError')</p>
        <x-primary-button x-on:click="$dispatch('close')">@lang('questionnaire-campaign.damocles.close')</x-primary-button>
    </div>
</x-modal>
